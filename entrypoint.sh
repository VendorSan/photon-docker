...
if [ ! -d "/photon/photon_data/elasticsearch" ]; then
    ...
    USER_AGENT="docker: vendorsan/photon-geocoder"
    ...
    wget --user-agent="$USER_AGENT" -O - http://download1.graphhopper.com/public/extracts/by-country-code/ng/photon-db-ng-latest.tar.bz2 | bzip2 -cd | tar x
